...
class BattleMechesControllerTest < ActionController::TestCase
  setup do
    @battle_mech = battle_meches(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:battle_meches)
  end
  ...
  test "should destroy battle_mech" do
    ...
    assert_redirected_to battle_meches_path
  end
end
